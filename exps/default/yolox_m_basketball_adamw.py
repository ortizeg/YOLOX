#!/usr/bin/env python3
# -*- coding:utf-8 -*-
"""YOLOX-M + AdamW fine-tuning on basketball detection dataset.

YOLOX-M (25.3M params) fine-tuned from COCO pretrained weights.
Trained at 800x800 for higher resolution features.
10 classes, mosaic+mixup augmentation, AdamW optimizer.
"""
...
class Exp(MyExp):
    def __init__(self):
        ...
        # AdamW optimizer — lower LR for larger model
        self.basic_lr_per_img = 0.0004 / 64.0
        self.adamw_lr = 0.0004
        self.adamw_weight_decay = 0.05

        # Strong mosaic + mixup for small dataset
