#!/usr/bin/env python3
# -*- coding:utf-8 -*-
"""DINO-X S + AdamW: DINOXHead with RTMDet training hyperparameters.

Combines DINOXHead improvements (QFL on all anchors, GT-class-only
assigner cost, GIoU loss, soft center prior, IoU-weighted reg) with
mmyolo's RTMDet training recipe (AdamW, lr=0.004, wd=0.05).
"""
