#!/usr/bin/env python3
# -*- coding:utf-8 -*-
"""YOLOX-S + AdamW fine-tuning on basketball detection dataset.

Fine-tune from COCO pretrained weights on basketball-player-detection-3.
10 classes: ball, ball-in-basket, number, player, player-in-possession,
player-jump-shot, player-layup-dunk, player-shot-block, referee, rim.

Dataset uses Roboflow COCO format:
  {split}/_annotations.coco.json   (annotations)
  {split}/*.jpg                     (images in same directory)
"""
